...
Rules that I can apply to each box that are rquired before submitting via code with a given provider like yup.

3. In 1-2 sentences, define end to end testing.

end to end testing is basically testing the over all functionality of an app from start to finish which takes some time. different from unit testing which refers to a single/smaller portion of an apps function.
